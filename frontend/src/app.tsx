...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/projects/:projectId/decision-makers" element={<DecisionMakers />} />
      <Route path="/projects/:projectId/wam-aggregation" element={<WAMAggregation />} />
      <Route path="/projects/:projectId/ahp-matrix" element={<AHPCriteriaMatrix />} />
      <Route path="/projects/:projectId/saw-analysis" element={<SAWAnalysis />} />
